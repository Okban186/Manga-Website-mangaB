...
function HeroSection({ children }) {
  ...
  const generateHeroBanner = useMemo(() => {
  ...
  return (
    ...
    <div className={cx("hero-section")}>
      ...
      <div className={cx("hero-banner")}>
        ...
        <Slider slide_each_element active_each_element spacingVisibale className={cx("slider-hero")} dots
          clickCardSlide changeHeroBackground={changeHeroBackground} items={generateHeroBanner} data={heroData} />
