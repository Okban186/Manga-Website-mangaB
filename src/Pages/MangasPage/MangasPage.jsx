...
function MangasPage(){
    ...
    useEffect(() =>{
        const callApi = async () =>{
            const response = await getBookById({id: 556})
    ...
    const renderingChapterList = () =>{
        ...
        for(let i = 20; i >= 1; i--){
            array.push(
                <div key={i} className={cx("chapter-item")}>
                    <h5>Chapter {i}</h5>
            ...
            <div className={cx("inner")}>
                ...
                <div className={cx("profile-manga")}>
                    <div className={cx("cover-art")}>
                        <div className={cx("img-cover")} style={{background: "linear-gradient(0deg, rgb(185, 149, 181) 0%, transparent 50%)"}}></div>
                        <picture>
