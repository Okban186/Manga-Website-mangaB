...
function Header({ position_non_fix = false, transparent_header = false, sentinal = false }) {

  const sentinelRef = useRef(null)
  const [transparentHeader, setTransparentHeader] = useState(transparent_header)
  useEffect(() => {
    setTransparentHeader(transparent_header)
  }, [transparent_header])
  useEffect(() => {
    if (!sentinal) return
